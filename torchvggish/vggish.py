...
class VGGish(VGG):
    def __init__(self, urls, pretrained=True, preprocess=True, postprocess=True, progress=True):
        ...
        if pretrained:
            ...
            model_path = path.join(prefix, 'vggish-10086976.pth')
        ...
        if self.postprocess:
            ...
            if pretrained:
                ...
                # pca_path = path.join(dirname, '../../data/weights/vggish_pca_params-970ea276.pth')
                pca_path = path.join(prefix, 'vggish_pca_params-970ea276.pth')
